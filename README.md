...
Web compilada y comprobada en escritorio y m�vil. Studio compilado y publicado; esquemas e im�genes importados. Pendiente: token de servidor para activar recepci�n de solicitudes, perfiles sociales, im�genes y URLs definitivas de proyectos, y credenciales Vercel/GitHub para el despliegue web. La secci�n de productos est� excluida del c�digo y del modelo editorial.
